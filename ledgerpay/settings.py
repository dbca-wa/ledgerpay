...
TEMPLATES[0]['DIRS'].append(os.path.join(BASE_DIR, 'ledgerpay', 'templates'))
BOOTSTRAP3 = {
...
SYSTEM_NAME_SHORT = env('SYSTEM_NAME_SHORT', 'LP')
SITE_PREFIX = env('SITE_PREFIX', '')
SITE_DOMAIN = env('SITE_DOMAIN', '')
SUPPORT_EMAIL = env('SUPPORT_EMAIL', 'ledgerpay@' + SITE_DOMAIN).lower()
...
ADMIN_GROUP = env('ADMIN_GROUP', 'Ledgerpay Admin')
